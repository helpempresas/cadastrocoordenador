...
class ConnectionManager
{
	...
	{
		return $this->byId( "coordenador_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "coordenador_at_localhost";
		$data["connName"] = "coordenador at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;coordenador;;1"; //currently unused
		
		$this->_connectionsIdByName["coordenador at localhost"] = "coordenador_at_localhost";
...
;
		...
		$connectionsData["coordenador_at_localhost"] = $data;
	...
	protected function _setTablesConnectionIds()
	{
		...
		$connectionsIds["tbl_coordenador"] = "coordenador_at_localhost";
		$connectionsIds["tbl_curso"] = "coordenador_at_localhost";
		$connectionsIds["tbl_unidade"] = "coordenador_at_localhost";
