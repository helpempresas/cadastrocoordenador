...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "tbl_coordenador" ] = array( "url" => "tbl_coordenador", "type" => 0 );
	$projectEntitiesReverse[ "tbl_coordenador" ] = "tbl_coordenador";
	$projectEntities[ "tbl_curso" ] = array( "url" => "tbl_curso", "type" => 0 );
	$projectEntitiesReverse[ "tbl_curso" ] = "tbl_curso";
	$projectEntities[ "tbl_unidade" ] = array( "url" => "tbl_unidade", "type" => 0 );
	$projectEntitiesReverse[ "tbl_unidade" ] = "tbl_unidade";
}
