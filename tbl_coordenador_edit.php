...
require_once("include/tbl_coordenador_variables.php");
...
$layout = new TLayout("edit_bootstrap", "MetroAvenue", "MobileAvenue");
$layout->version = 3;
...
$page_layouts["tbl_coordenador_edit"] = $layout;
...
$layout = new TLayout("list_bootstrap1", "MetroAvenue", "MobileAvenue");
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
...
$page_layouts["tbl_coordenador_list"] = $layout;
...
$keys = array();
$keys["idCoordenador"] = postvalue("editid1");
