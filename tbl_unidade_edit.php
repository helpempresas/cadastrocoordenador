...
require_once("include/tbl_unidade_variables.php");
...
$page_layouts["tbl_unidade_edit"] = $layout;
...
$page_layouts["tbl_unidade_list"] = $layout;
...
$keys = array();
$keys["idUnidade"] = postvalue("editid1");
