...
class tDAL
{
	var $tblcoordenador_at_localhost__tbl_coordenador;
	var $tblcoordenador_at_localhost__tbl_curso;
	var $tblcoordenador_at_localhost__tbl_unidade;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "tbl_coordenador", "varname" => "coordenador_at_localhost__tbl_coordenador", "altvarname" => "tbl_coordenador", "connId" => "coordenador_at_localhost", "schema" => "", "connName" => "coordenador at localhost");
		$this->lstTables[] = array("name" => "tbl_curso", "varname" => "coordenador_at_localhost__tbl_curso", "altvarname" => "tbl_curso", "connId" => "coordenador_at_localhost", "schema" => "", "connName" => "coordenador at localhost");
		$this->lstTables[] = array("name" => "tbl_unidade", "varname" => "coordenador_at_localhost__tbl_unidade", "altvarname" => "tbl_unidade", "connId" => "coordenador_at_localhost", "schema" => "", "connName" => "coordenador at localhost");
	}
