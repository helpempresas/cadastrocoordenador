...
function checkTableName($shortTName, $type=false)
{
	...
	if ("tbl_coordenador" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("tbl_curso" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("tbl_unidade" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	return false;
}
